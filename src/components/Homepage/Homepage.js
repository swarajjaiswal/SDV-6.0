        ...
        <div className="">
          <div className="flex flex-col md:flex-row items-center space-y-8 md:space-x-8 mx-12">
            ...
            <div className="flex-1 text-center md:text-left">
              <p className="text-8xl sdv-heading font-bold leading-tight text-transparent bg-clip-text bg-gradient-to-r from-[#0FF] to-[#0FF] drop-shadow-lg">
              ...
              <div className="mt-6">
                <p className="flex items-center">
                  <MapPin className="mr-2 text-[#FFD700]" /> {/* Icon color */}
                  <span className="text-[#ace1af]"> {/* Text color */}
                    National Institute of Technology Durgapur
                  </span>
                </p>
                <p className="flex items-center mt-2">
                  <CalendarDays className="mr-2 text-[#FFD700]" /> {/* Icon color */}
                  <span className="text-[#ace1af]"> {/* Text color */}
