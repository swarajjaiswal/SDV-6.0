        ...
        <div className="">
          <div className="flex flex-col md:flex-row items-center space-y-8 md:space-x-8 mx-12">
            ...
            <div className="flex-1 text-center md:text-left">
              <p className="text-8xl sdv-heading font-bold leading-tight text-transparent bg-clip-text bg-gradient-to-r from-[#387478] to-[#E2F1E7] drop-shadow-lg">
                Self Driving Vehicles
              </p>
              <p className="text-xl text-[#E2F1E7] mt-4">
                Discover the future of autonomous transportation with advanced
                technology and innovation.
              </p>
              <div className="mt-6">
                <p className="flex items-center text-[#E2F1E7]">
                  <MapPin className="mr-2" /> National Institute of Technology
                  Durgapur
                </p>
                <p className="flex items-center text-[#E2F1E7] mt-2">
